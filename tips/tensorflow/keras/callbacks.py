...
from tips._keras import callbacks as _impl
...
class LearningRateScheduleCallback(_impl.LearningRateScheduleCallbackImpl,
    ...
    def __init__(self,
        ...
        super(LearningRateScheduleCallback, self).__init__(
            K, initial_lr, multiplier, start_epoch, end_epoch, staircase,
...
class LearningRateWarmupCallback(_impl.LearningRateWarmupCallbackImpl,
    ...
    def __init__(self,
        ...
        super(LearningRateWarmupCallback, self).__init__(
            K, initial_lr, warmup_epochs, momentum_correction, steps_per_epoch,
            verbose)
